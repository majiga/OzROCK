...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 23 19:37:24 2020

@author: majiga

Iron Ore KG create and Subgraph from key words
"""
...
"""
What are the first 10 key words come to your mind, when you think of 'iron ore'?
Hematite
Goethite
Magnetite
...
if ('iron ore' in KG.nodes()):
    ego = nx.ego_graph(KG, 'iron ore', radius=1)
    #nx.write_gpickle(ego, FOLDER_KG + "iron_ore.gpickle")
    save_graph(KG, FOLDER_KG + "ego_" + COMM_ + ".json")
...
H = KG.subgraph(['iron ore', 'iron', 'hematite', 'goethite', 'magnetite', 
                 'banded iron formation', 'iron ore deposit', 'martite', 'hamersley', 'hamersley group',
                 'laterite', 'pilbara', 'mid west', 'archaean', 'direct shipping ore'])
...
for n in H.nodes(data=True):
    print(n)
for s,t,a in H.edges(data=True):
    print([s], [t], [a])
"""
